...
gte = '2022-04-07T00:00:00.000Z'
lt = '2022-04-07T12:00:00.000Z'
...
arr = []
with open(f'data/running-window/source.json', 'r') as read_file:
...
with open(f'data/running-window/source.json', 'w') as dataOutFile:
